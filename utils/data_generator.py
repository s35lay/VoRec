...
class Data(object):
    ...
    def generate_adj(self):
        ...
        coo_user_item = sp.coo_matrix((data, (rows, cols)), shape=(self.num_users, self.num_items))
        ...
        data = np.ones((coo_user_item.nnz * 2,), dtype=np.float32)
        adj_csr = sp.coo_matrix((data, (rows, cols))).tocsr()
        ...
        return adj_csr, coo_user_item.toarray()
